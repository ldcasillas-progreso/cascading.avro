...
//    if (schema == null) {
   ...
   */
  @Override
  public void sink(FlowProcess<Configuration> flowProcess, SinkCall<Object[], OutputCollector> sinkCall) throws IOException {
   ...
   */
  @Override
  public void sinkPrepare(FlowProcess<Configuration> flowProcess, SinkCall<Object[], OutputCollector> sinkCall)
      throws IOException {
  }
   ...
   */
  @Override
  public Fields retrieveSourceFields(FlowProcess<Configuration> flowProcess, Tap tap) {
    if (schema == null) {
   ...
   */
  @Override
  public boolean source(FlowProcess<Configuration> flowProcess, SourceCall<Object[], RecordReader> sourceCall) throws IOException {
